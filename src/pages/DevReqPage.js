    ...
    return (
        <>
            <div className="article mt-5">
                <h2>Эаявка на разработку курса</h2>
                <p>В условиях оперативного перехода на дистанционное обучение УрФУ предлагает вам актуальный и не
                    требующий специальных навыков инструмент для создания онлайн-курсов – <a
                        title="Платформа открытого образования УрФУ" href="https://courses.openedu.urfu.ru"
                ...
                <ol>
                    <li>Зарегистрироваться на странице <a title="Регистрация на Портале открытого образования"
                ...
                <p>После этого вам будет предоставлен доступ для работы на платформе, и вы сможете либо самостоятельно
                    перевести ваш курс в онлайн-формат, либо воспользоваться профессиональной помощью сотрудников Центра
                    новых образовательных технологий и аудиовизуальных средств обучения.</p>
            </div>
            <div className="mb-5">
            ...
            <div className="form-group">
                ...
                <div className="form-check">
                    <input className="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2"
                           value="option2"/>
                        <label className="form-check-label" htmlFor="inlineRadio2">Технические специалисты ЦНОТ</label>
                </div>
                <small className="form-text text-muted"></small>
            </div>
            <div className="form-group">
